...
import { X, ArrowRight, ChevronRight, Wallet, Loader2 } from "lucide-react";
...
export function WalletDialog({ open, onOpenChange, walletEnabled = true }: WalletDialogProps) {
    ...
    const { balance, currency, transactions, hasMoreTransactions, isLoadingMore, loadMoreTransactions, isLoading, refetch } = useWallet();
                    ...
                    >
                        ...
                        <div className="bg-white">
                            ...
                            <div className={`overflow-y-auto ${walletEnabled ? 'max-h-[250px]' : 'max-h-[400px]'}`}>
                                ...
                                {/* See More */}
                                {!isLoading && transactions.length > 0 && hasMoreTransactions && (
                                    <button
                                        onClick={loadMoreTransactions}
                                        disabled={isLoadingMore}
                                        className="w-full py-3 text-center text-sm font-semibold text-primary hover:bg-gray-50 transition-colors border-t border-gray-100 flex items-center justify-center gap-2"
                                    >
                                        {isLoadingMore ? (
                                            <>
